...
public class dataAnomalyMain {
	...
	public static void main(String[] args) {
        ...
        System.out.println("\n");            
        System.out.printf("Stdev   arr[] : %s",Arrays.toString(stddevArray));
		obj.getdataPoint(2,"ZScr");
		obj.getdataPoint(3,"Anom");
        System.out.println("\n");            
        System.out.printf("Anomaly arr[] : %s",Arrays.toString(arryAnomaly));
